...
//$result = 'The value is'.$POST['offer_img']."With size ".strlen ( $POST['offer_img']) ;

$offer = new Offers;
$updateOffer = $offer->updateOffer($offer_data);

if($updateOffer)
{
  //echo json_encode(array('response'=>'success', 'result'=>$result), JSON_FORCE_OBJECT);
